...
-- AddEventHandler("es_freeroam:notify", function(icon, sender, title, text)
TriggerClientEvent("es_freeroam:notify", source, "CHAR_SOCIAL_CLUB", "Maze Bank", "v0.1.0", "Your money is now available")
